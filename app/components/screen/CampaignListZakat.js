...
export default class CampaignListZakat extends Component {
    ...
    return (
      <StyleProvider style={getTheme(material)}>
        <Card style={{ flex: 0 }}>
          ...
          <CardItem>
            <Body>
              <Image source={{ uri: baseUrl + "public/campaigns/large/" + rowData.large_image }} style={{ height: 200, width: "100%", flex: 1 }} resizeMode="cover" />
            </Body>
          </CardItem>
          <CardItem>
            <Left>
