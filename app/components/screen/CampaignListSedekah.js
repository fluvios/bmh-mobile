...
export default class CampaignListSedekah extends Component {
    ...
    return (
      <StyleProvider style={getTheme(material)}>
        <Card style={{ flex: 0 }}>
          ...
          <CardItem>
            <Body>
              <Image source={{ uri: baseUrl + "public/campaigns/large/" + rowData.large_image }} resizeMode="cover" style={{ height: 200, width: "100%", flex: 1 }} />
            </Body>
          </CardItem>
          <CardItem>
            <Left>
