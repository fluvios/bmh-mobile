...
export default class CampaignTransferPayment extends Component {
    ...
    doUpload() {
        ...
        const donationId = this.props.navigation.state.params.donationId
        this.transfer(donationId, formData, response => {
            Toast.show({
    ...
    transfer(params, data, callback) {
        fetch("http://galangbersama.com/api/transfer/" + params, {
            method: "POST",
            body: data,
        })
